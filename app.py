...
Luas_Tanam = st.number_input("Luas Tanam (Ha) (min: 0, maks: 1000000) ", min_value=0.0, max_value=1000000, format="%.2f")
# Luas Panen dengan satuan hekta
Luas_Panen = st.number_input("Luas Panen (Ha) (min: 0, maks: 1000000) ", min_value=0.0, max_value=1000000, format="%.2f")
# Produktivitas dengan satuan Ku/Ha
Produktivitas = st.number_input("Produktivitas (Ku/Ha) (min: 0, maks: 10000) ", min_value=0.0, max_value=10000, format="%.2f")
